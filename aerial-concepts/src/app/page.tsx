          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-lg text-sm text-ink-500 sm:text-base">
                Proper departments — kits, jets, helicopters, radios, power systems and build supplies.
              </p>
            </div>
            <Link href="/shop" className="btn-secondary self-start sm:self-auto">
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="container-page relative grid gap-10 py-16 sm:py-20 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:py-24">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur sm:p-8">
            <p className="font-mono text-xs uppercase tracking-[0.2em] text-ink-300">Trading hours</p>
            <ul className="mt-5 space-y-3 text-sm">
              {STORE.hours.map((h) => (
                <li key={h.day} className="flex items-baseline justify-between gap-4 border-b border-white/10 pb-3 last:border-0">
