...
export const metadata: Metadata = {
  ...
  description:
    "South Africa's biggest model aircraft shop. RC planes, jets, helicopters, drones and the parts to keep them flying.",
  ...
  return (
    <html lang="en-ZA" className={`${manrope.variable} ${syne.variable} ${plexMono.variable}`}>
      <body className="min-h-dvh font-sans antialiased">
        <SmoothScroll />
        <Header categories={categories} phone={STORE.phone} />
        <main>{children}</main>
        <Footer />
      </body>
    </html>
